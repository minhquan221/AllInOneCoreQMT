...
namespace AllinOne.Core.Convertor
{
    public class ConvertHelper
    {
        ...
        private Dictionary<string, string> vn_str_pt = new Dictionary<string, string>();
        /// <summary>
        /// 
        /// </summary>
        ...
        /// <returns></returns>
        public T ParseEnum<T>(string vl)
        {
        ...
        /// <returns></returns>
        public string DeUnicodeConvert(string input)
        {
        ...
        public string UrlFormatConvert(string input)
        {
            if (!String.IsNullOrEmpty(input))
            {
        ...
        public string FormatDateTime(DateTime? date, string strFormatString)
        {
            return date != null ? Convert.ToDateTime(date).ToString(strFormatString) : "";//"HH:mm, dd/MM/yyyy"
        }

        public string CollapseString(string strString, int length)
        {
        ...
        public T ConvertObjectToObject<T>(T objConvert, Object obj)
        {
